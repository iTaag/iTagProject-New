//
//  DealsModelBusinessAddress.swift
...
class DealsModelBusinessAddress : NSObject, NSCoding{
    ...
    var location : DealsModelLocation!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let locationData = dictionary["location"] as? [String:Any]{
            location = DealsModelLocation(fromDictionary: locationData)
        }
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        addressName = aDecoder.decodeObject(forKey: "addressName") as? AnyObject
        ...
        location = aDecoder.decodeObject(forKey: "location") as? DealsModelLocation
